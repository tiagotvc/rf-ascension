...
export default async function Forum() {
  ...
  return (
    <main className="forum-page">
      <header className="site-header forum-nav"><a className="brand" href="/"><span className="brand-mark">RF</span><span className="brand-copy"><strong>ECHELON</strong><small>PRIVATE SERVER</small></span></a><nav><a href="/">Início</a><a href="/#download">Download</a><a href="/doacao">Doação</a><a className="active" href="/forum">Fórum</a><a href="/conta">Minha conta</a></nav><div className="header-tools"><span className="lang-switch"><b>PT</b><a href="/en/forum">EN</a></span><a className="header-cta" href="/conta">Criar conta</a></div></header>
      <section className="forum-hero compact"><span className="kicker">COMUNIDADE RF ECHELON</span><h1>Fórum da <em>comunidade.</em></h1><p>Encontre informações, aprenda os sistemas do jogo e participe das discussões.</p><div className="forum-tools"><label><span>⌕</span><input aria-label="Pesquisar no fórum" placeholder="Pesquisar em todas as áreas..." /></label><a className="btn btn-primary" href="#areas">Explorar áreas ↓</a></div></section>
